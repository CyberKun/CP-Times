    ...
    <div className="min-h-screen bg-[#0D1117] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      ...
      >
          ...
          <div className="space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between">
                ...
                <Link href="/forgot-password" className="text-xs font-medium text-[#8B949E] hover:text-[#E6EDF3] transition-colors duration-100">
                  Forgot password?
                </Link>
              </div>
              <input
        ...
        <div className="text-center text-sm">
          ...
          <Link href="/register" className="font-medium text-[#8B949E] hover:text-[#E6EDF3] transition-colors duration-100">
            Register here
          </Link>
        </div>
      </div>
